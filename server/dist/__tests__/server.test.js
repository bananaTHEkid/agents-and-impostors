...
describe("Game Server API Endpoints (In-Memory)", () => {
    beforeAll(() => __awaiter(void 0, void 0, void 0, function* () {
        yield (0, server_1.startServer)(TEST_PORT);
    }));
    let clientSockets = [];
    beforeEach(() => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield db.exec("DELETE FROM votes");
    }));
    afterEach(() => {
    ...
    it("should allow a player to join an existing lobby", (done) => {
        const clientSocket = (0, socket_io_client_1.io)(`http://localhost:${TEST_PORT}`);
        ...
        (0, supertest_1.default)(server_1.app)
            ...
            const connectPlayerSocket = (playerName, isCreator = false) => {
                return new Promise((resolve, reject) => {
                    const socket = (0, socket_io_client_1.io)(`http://localhost:${TEST_PORT}`);
    ...
    it("should submit votes and calculate win conditions", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        // Start the game
        yield db.run("UPDATE lobbies SET status = 'playing' WHERE id = ?", [lobbyResponse.body.lobbyId]);
