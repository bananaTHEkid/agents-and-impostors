...
io.on("connection", (socket) => {
    ...
    socket.on("submit-vote", (_a) => __awaiter(void 0, [_a], void 0, function* ({ lobbyCode, username, targetPlayer }) {
        try {
            const db = (0, db_1.getDB)();
...
// Start the server
const startServer = (...args_1) => __awaiter(void 0, [...args_1], void 0, function* (useInMemory = false) {
    try {
